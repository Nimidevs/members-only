...
router.get("/", loggedIn, index.index_get);
...
router.get("/become-a-member", loggedIn, index.index_become_a_member_get);
router.post("/become-a-member", index.index_become_a_member_post);

//Become A member routes
router.get("/become-an-admin", loggedIn, index.index_become_an_admin_get);
router.post("/become-an-admin", index.index_become_an_admin_post);

//Create Messages routes
router.get("/create-message", loggedIn, message.create_message_get);
router.post("/create-message", message.create_message_post);

// //Update Messages routes
router.get("/update-message/:id", loggedIn, message.update_message_get);
